...
// Thousandth diagonal for more accurate bullet disapear and fast movement enemies
//
//
//
//
...
/*
    if (rightIsPressedInstant){
      this.wave++;this.phase=0;
      for(var i =0;i<gameManager.bads.length; i++) {
        gameManager.bads[i].isDead=true;
  ...
  this.draw = function() {
    ...
    if (this.isWon) {
      ...
      if (this.waveTextTimeout > 0) {
        ...
        ctx.fillText("W a v e", (canvas.width / 2) - canvas.width*0.205, (canvas.height / 2) - canvas.width/24);
